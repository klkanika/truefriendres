...
class BetterDocs_Elementor_Sidebar extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $sidebar = '<aside id="betterdocs-sidebar" class="betterdocs-el-single-sidebar"><div class="betterdocs-sidebar-content betterdocs-category-sidebar">' . $shortcode . '</div>' . $sticky_toc . '</aside>';
