...
class BetterDocs_Elementor_Category_Grid extends Widget_Base {
    ...
    protected function _register_controls()
    {
         ...
         */
        do_action('betterdocs/elementor/widgets/query', $this);
	...
	protected function render()
    {
        ...
        if($default_multiple_kb) {
            ...
            $taxonomy_objects = BetterDocs_Elementor::get_multiple_kb_terms(false, false);
            $meta_query = '';
                ...
                if (file_exists($this->get_template($settings['layout_template']))) {
                    if($taxonomy_objects && ! is_wp_error( $taxonomy_objects )) {
                        foreach($taxonomy_objects as $term) {
                            echo BetterDocs_Elementor::include_with_variable($this->get_template($settings['layout_template']), ['term' => $term, 'settings' => $settings, 'default_multiple_kb' => $default_multiple_kb]);
                        }
                    } else {
                        _e('<p class="no-posts-found">No posts found!</p>', 'betterdocs');
                    }
    ...
    ?>
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                $('.el-betterdocs-category-grid').each(function() {
                    ...
                    if($layout_mode === 'masonry') {
                        ...
                        $('.el-betterdocs-category-grid-post', $gallery).resize(function() {
                            $isotope_gallery.isotope('layout');
                        });
                    }
