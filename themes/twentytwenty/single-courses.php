  ...
  <section id="documents" class="text-white pt-32 w-full flex items-center flex-col" style="background-color: #F2F2F2; color:#262145;">
    ...
    <div class="swiper-container w-full">
      <div class="swiper-wrapper md:pl-48 pl-4">
        <!-- Slides -->
        <?php foreach ([0, 0, 0, 0, 0, 0] as $thePost) : ?>
          <!-- <div class="swiper-slide rounded-xl overflow-hidden banner-slide bg-gray-300">
          </div> -->
          <div class="swiper-slide rounded-xl overflow-hidden banner-slide"><img class="object-cover w-full h-full" src="<?= get_theme_file_uri() ?>/assets/images/courses-offline-02.png" alt="" /></div>
        <?php endforeach; ?>
      </div>
      <!-- Add Arrows -->
    ...
    <div class="w-full md:pl-48 md:pr-48 mt-16 mb-12 px-4">
      ...
      <iframe width="100%" height="450" src="https://www.youtube.com/embed/ScSgxEkMdVo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
