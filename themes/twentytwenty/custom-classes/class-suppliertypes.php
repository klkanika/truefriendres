        ...
        if ($terms) {
            ...
            foreach ($terms as $term) {
                if ($count < $postsPerPage) {
                    ...
                    $supplierType->featuredImage = get_field('pictureUrl', $term) && @getimagesize(get_field('pictureUrl', $term)) ? get_field('pictureUrl', $term) : get_theme_file_uri() . '/assets/images/img-default.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260';
