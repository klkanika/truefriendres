...
<body  class="w-full">
  ...
  <section id="infohub" class="text-white pt-40 w-full flex items-center flex-col">
    ...
    <div class="flex justify-center flex-wrap w-full mt-16 mb-12">
      <a href="<?= get_site_url() ?>/suppliers" class="cursor-pointer lg:w-1/5 w-full flex lg:items-center lg:justify-center flex-col lg:h-64 h-40 relative lg:mb-0 mb-4 lg:ml-2 lg:mr-2 ml-4 mr-4 rounded-md" style="background-color:#FFD950">
      ...
      <a href="<?= get_site_url() ?>/restaurants" class="cursor-pointer lg:w-1/5 w-full flex lg:items-center lg:justify-center flex-col lg:h-64 h-40 relative lg:mb-0 mb-4 text-white lg:ml-2 lg:mr-2 ml-4 mr-4 rounded-md" style="background-color:#262145">
        <div class="lg:text-center px-4 pt-4 lg:pb-10">
      ...
      <a href="<?= get_site_url() ?>/franchises" class="cursor-pointer lg:w-1/5 w-full flex lg:items-center lg:justify-center flex-col lg:h-64 h-40 relative lg:mb-0 mb-4 bg-white lg:ml-2 lg:mr-2 ml-4 mr-4 rounded-md" style="color:#251D5C">
        <div class="lg:text-center px-4 pt-4 lg:pb-10">
