<div class="flex flex-wrap justify-center text-white lg:pb-32 pb-16" style="color:<?= var_dump(isset($footercolor)) ? $footercolor : 'white' ?>;background-color:<?= var_dump(isset($footerbgcolor)) ? $footerbgcolor : '#262145' ?>;">
