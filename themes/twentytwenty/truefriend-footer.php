<div class="flex flex-wrap justify-center text-white lg:pb-32 pb-16" style="background-color:#262145;">
	<div class="flex justify-between w-full">
		<div class="ml-8 mt-10 mb-10 lg:block hidden">
			<div class="flex items-center justify-start mb-6">
				<img src="<?= get_theme_file_uri() ?>/assets/images/logo-white.svg" class="cursor-pointer w-32" />
	...
	<div class="mt-10 lg:hidden text-center">
		<div class="flex items-center justify-center mb-4">
			<img src="<?= get_theme_file_uri() ?>/assets/images/logo-white.svg" class="cursor-pointer mr-2" />
